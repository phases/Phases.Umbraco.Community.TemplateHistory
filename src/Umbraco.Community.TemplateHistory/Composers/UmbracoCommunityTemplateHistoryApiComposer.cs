...
{
    public class UmbracoCommunityTemplateHistoryApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Template History Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunityTemplateHistoryOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunityTemplateHistoryOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.TemplateHistory.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
